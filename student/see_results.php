                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                             ...
                                             <?php
                                                    ...
                                                    $sql = "SELECT COUNT(*) FROM exams where Class='$class_joined'";
                            ...
                            <div class="card shadow h-100 py-2" style="border-left: 4px solid #FF4584;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Exams Attended</div>
                                             <?php
                                                    $s_id = $_SESSION['sid'];
                                                    $class_joined = $_SESSION['class_joined'];
                                                    $sql = "SELECT COUNT(*) FROM submit_exam where sid='$s_id'";
                                                    $result = mysqli_query($conn, $sql);
                                                    $count = mysqli_fetch_assoc($result)['COUNT(*)']; 
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">'.$count.'</div>';
                                                    ?> 
                            ...
                            <div class="card shadow h-100 py-2" style="border-left: 4px solid #FF4584;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Student Highest Score in Exam</div>
                                             <?php
                                                   $s_id = $_SESSION['sid'];
                                                   $class_joined = $_SESSION['class_joined'];
                                                   $sql = "SELECT MAX(total_score) FROM submit_exam where sid='$s_id'";
                                                   $result = mysqli_query($conn, $sql);
                                                   $count = mysqli_fetch_assoc($result)['MAX(total_score)']; 
                                                   echo '<div class="h5 mb-0 font-weight-bold text-gray-800">'.$count.'</div>';
                                                    ?> 
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                         <?php
                                                $s_id = $_SESSION['sid'];
                                                $existSql = "SELECT * FROM submit_exam where sid  = $s_id";
                                                ...
                                                while ($row = mysqli_fetch_assoc($resultchk))  {
                                                    if($numRows>0){
                                                        ...
                                                        $existSql3 = "SELECT * FROM exams where id  = $exid";
                                                        $resultchk3 = mysqli_query($conn, $existSql3);
                                                        while ($row2 = mysqli_fetch_assoc($resultchk3)){
                                                        echo'<td>'.$row2['Title'].'</td>';
                                                        echo'  <td>'.$row['total_score'].'</td>';
                                                        echo'  <td>'.$row2['Total Marks'].'</td>';
